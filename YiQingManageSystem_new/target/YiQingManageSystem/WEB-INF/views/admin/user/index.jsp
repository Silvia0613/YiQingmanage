    ...
    <div id="dialog-message" class="hide">
        <form id="dialog-form">
            ...
            <div style="margin: 10px 0px;">
                ...
                <input type="text" id="identifyCard" name="identifyCard" placeholder="请输入身份证号..." style="width: 250px; float: none">
            </div>
            <div style="margin: 10px 0px;">
                <label style="width: 100px;">用户手机号：</label>
                <input  type="number" onkeyup="this.value= this.value.match(/\d+(\.\d{0,2})?/) ? this.value.match(/\d+(\.\d{0,2})?/)[0] : ''" id="phone" name="phone" placeholder="请输入用户手机号..." style="width: 250px; float: none">
            </div>
            <div style="margin: 10px 0px;">
    ...
    function openDialog(title, type) {
        if(type === 'add'){
            ...
            if(selectRow.length !== 1){
                ...
                $("#identifyCard").val(row.identifyCard);
            }
        }
