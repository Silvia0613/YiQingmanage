                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div style="margin: 10px 0px;">
                                    ...
                                    <input id="title" name="title" style="width: 600px;" />
                                </div>
                                <div style="margin: 10px 0px;position: relative;">
                                    <label style="width: 100px;position: absolute;top:30px;left:0px">新闻内容：</label>
                                    <textarea id="content" name="content" style="width: 850px;height:300px;position: absolute;top:30px;left:100px"></textarea>
                                </div>
...
<script type="text/javascript">
    ...
    function saveNews() {
        $.ajax({
            ...
            dataType:'json',
            type:'post',
            data:{title: $("#title").val(), content: ue.getContent()},
