        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    <button class="btn btn-sm btn-warning" style="margin-bottom: 4px;" onclick="openDialog('添加线索信息', 'add')">
                        <i class="ace-icon glyphicon glyphicon-plus"></i>
                        添加
                    </button>
                    <button class="btn btn-sm btn-info" style="margin-bottom: 4px;" onclick="openDialog('修改线索信息', 'edit')">
                    ...
                    <input type="text" id="search-name" placeholder="请输入线索内容..." style="width: 200px; float: none">
    ...
    <div id="dialog-message" class="hide">
        <form id="dialog-form">
            ...
            <div style="margin: 10px 0px;position: relative">
                <label style="width: 100px;position: absolute;left: 10px;top:50px;">线索内容：</label>
                <textarea type="text" id="content" name="content" placeholder="请输入线索内容..." style="width: 250px; height: 100px; position: absolute;left:100px;top:10px;"></textarea>
            </div>
            <div style="margin: 10px 0px;position: relative">
                <label style="width: 100px;position: absolute;left: 10px;top:135px;">线索提供者：</label>
                <select name="userId" id="userId" style="width: 250px;position: absolute;left:100px;top:130px;">
