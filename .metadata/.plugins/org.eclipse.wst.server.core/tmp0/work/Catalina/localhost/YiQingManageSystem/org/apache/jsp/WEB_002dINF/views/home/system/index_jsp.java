 ...
 * Generated at: 2022-06-28 08:57:04 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.home.system;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/home/system/../common/header.jsp", Long.valueOf(1656406589051L));
    _jspx_dependants.put("/WEB-INF/views/home/system/../common/footer.jsp", Long.valueOf(1645939795641L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <a href=\"\" class=\"layui-this\">新闻</a>\r\n");
      out.write("                </div>\r\n");
      out.write("\r\n");
      out.write("                <ul class=\"fly-list\" id=\"news-list\">\r\n");
      out.write("                    ");
      ...
      out.write("                        <a href=\"javascript:void(0)\" id=\"more-news\" onclick=\"moreNews()\" class=\"laypage-next\">更多内容...</a>\r\n");
      out.write("                        <a href=\"javascript:void(0)\" style=\"display: none\" id=\"no-more-news\" class=\"laypage-next\">已无更多内容...</a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("\r\n");
      out.write("            </div>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${newsList.page}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\";\r\n");
      out.write("    var totalPage = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${newsList.totalPage}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\";\r\n");
      out.write("    function moreNews(){\r\n");
      out.write("        currentPage = parseInt(currentPage);\r\n");
      out.write("        totalPage = parseInt(totalPage);\r\n");
      out.write("        if(currentPage === totalPage){\r\n");
      out.write("            $(\"#more-news\").text(\"已无更多内容...\");\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            url:'../news/more',\r\n");
      out.write("            dataType:'json',\r\n");
      out.write("            type:'post',\r\n");
      out.write("            data:{page:currentPage+1},\r\n");
      out.write("            success:function(result){\r\n");
      out.write("                if(result.code === 0){\r\n");
      out.write("                    var newList = result.data.list;\r\n");
      out.write("                    currentPage =  result.data.page;\r\n");
      out.write("                    for(var i=0; i<newList.length; i++){\r\n");
      out.write("                        var html = '<li><a href=\"javascript:void(0);\" class=\"fly-avatar\">'+\r\n");
      out.write("                            '<img src=\"../../common/file/view_photo?filename='+ newList[i].user.headPic +'\" alt=\"\"></a>'+\r\n");
      out.write("                            '<h2><a class=\"layui-badge\">文章</a><a href=\"../news/detail?id='+newList[i].id+'\">'+newList[i].title+'</a></h2>'+\r\n");
      out.write("                            '<div class=\"fly-list-info\"><a href=\"javascript:void(0);\" link><cite>'+ newList[i].user.username+'</cite></a>'+\r\n");
      out.write("                            '<span>'+format(newList[i].createTime)+'</span>'+\r\n");
      out.write("                            '<span class=\"fly-list-nums\"><i class=\"iconfont icon-pinglun1\" title=\"评论量\"></i> '+newList[i].commentNum +\r\n");
      out.write("                            '<i class=\"iconfont\" title=\"浏览量\">&#xe60b;</i> '+newList[i].viewNum +\r\n");
      out.write("                            '</span> </div><div class=\"fly-list-badge\"></div></li>';\r\n");
      out.write("                        $(\"#news-list\").append(html);\r\n");
      out.write("                    }\r\n");
      out.write("                }else{\r\n");
      out.write("                    layer.alert(result.msg, {icon: 5});\r\n");
      out.write("                }\r\n");
      out.write("            },\r\n");
      out.write("            error:function(){\r\n");
      out.write("                layer.alert(\"网络错误，获取更多内容失败！\", {icon: 5});\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/home/system/../common/header.jsp(18,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/home/system/../common/header.jsp(34,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/home/system/index.jsp(18,20) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/home/system/index.jsp(18,20) '${newsList.list}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${newsList.list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/home/system/index.jsp(18,20) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("                        <li>\r\n");
            out.write("                            <a href=\"javascript:void(0);\" class=\"fly-avatar\">\r\n");
            out.write("                                <img src=\"../../common/file/view_photo?filename=");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${news.user.headPic}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\" alt=\"\">\r\n");
            out.write("                            </a>\r\n");
            out.write("                            <h2>\r\n");
            out.write("                                <a class=\"layui-badge\">文章</a>\r\n");
            ...
            out.write("                                <a href=\"javascript:void(0);\" link>\r\n");
            out.write("                                    <cite>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${news.user.username}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</cite>\r\n");
            out.write("                                </a>\r\n");
            out.write("                                <span>");
            ...
            out.write("                                <i class=\"iconfont icon-pinglun1\" title=\"评论量\"></i> ");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${news.commentNum}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\r\n");
            out.write("                                <i class=\"iconfont\" title=\"浏览量\">&#xe60b;</i> ");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${news.viewNum}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\r\n");
            out.write("                            </span>\r\n");
            out.write("                            </div>\r\n");
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/home/system/index.jsp(31,38) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatDate_005f0.setPattern("yyyy-MM-dd HH:mm:ss");
      // /WEB-INF/views/home/system/index.jsp(31,38) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/home/system/index.jsp(57,16) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/home/system/index.jsp(57,16) '${hotNewsList}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${hotNewsList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/home/system/index.jsp(57,16) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("hotNews");
