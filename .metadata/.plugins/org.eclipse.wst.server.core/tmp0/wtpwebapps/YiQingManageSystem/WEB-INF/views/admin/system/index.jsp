                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="alert alert-block alert-success">
                            ...
                            欢迎使用社区疫情后台管理系统！ 当前时间：<span id="now-time"></span>
                        </div>
                        <div>
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    <div class="center">
                                        ...
                                        <span class="btn btn-app btn-sm btn-pink no-hover">
                                            <span class="line-height-1 bigger-170"> ${goodApplyTotal} </span>
                                            <br />
                                            <span class="line-height-1 smaller-90"> 物资申请数 </span>
                                        </span>

                                        <span class="btn btn-app btn-sm btn-grey no-hover">
                                            <span class="line-height-1 bigger-170"> ${newsTotal} </span>
                                            <br />
                                            <span class="line-height-1 smaller-90"> 新闻数 </span>
                                        </span>

                                        <span class="btn btn-app btn-sm btn-success no-hover">
                                            <span class="line-height-1 bigger-170"> ${dailyReportTotal} </span>
                                            <br />
                                            <span class="line-height-1 smaller-90"> 日常打卡数 </span>
                                        </span>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="editable" id="login">
                                                    <fmt:formatDate value="${ADMIN_USER.loginTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                                                </span>
                                            </div>
                                        </div>
